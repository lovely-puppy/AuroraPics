package com.wws.imageplatformback.manager.websocket;
...
import com.wws.imageplatformback.manager.disruptor.PictureEditEventProducer;
import com.wws.imageplatformback.manager.websocket.model.PictureEditActionEnum;
import com.wws.imageplatformback.manager.websocket.model.PictureEditMessageTypeEnum;
import com.wws.imageplatformback.manager.websocket.model.PictureEditRequestMessage;
import com.wws.imageplatformback.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
  ...
  protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
    ...
    // 获取消息内容， 将 Json 转化为 PictureEditMessage
    ...
    PictureEditMessageTypeEnum pictureEditMessageTypeEnum =
        PictureEditMessageTypeEnum.valueOf(type);
