package com.wws.imageplatformback.manager.auth.annotation;
...
public @interface SaSpaceCheckPermission {
   ...
   *
   * <p>例1：@SaCheckPermission(value="user-add", orRole="admin")， 代表本次请求只要具有 user-add权限 或 admin角色
   * 其一即可通过校验。
   *
   * <p>例2： orRole = {"admin", "manager", "staff"}，具有三个角色其一即可。 <br>
